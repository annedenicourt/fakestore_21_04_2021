           ...
           <div className="row gap-5 justify-content-center mb-5">
               ...
               <div className="col-10 col-lg-7">
                ...
                <div className="col-6 col-lg-2 ">
                    <div className="border rounded p-3 shadow">
                        <div className="">Articles </div>
                        <div className="fw-bold fs-2 mb-4">{cartItem.length}</div>
                        <div className="">Total panier </div>      
                        <div className="fw-bold fs-2 mb-4" id="prix_total"></div>
                        <Link className="mb-5 mt-3" to="/cart"><button className="button btn btn-sm fw-bold">VALIDEZ VOTRE COMMANDE</button></Link>
                        <button className="btn mt-4" onClick={deleteCart}>VIDER LE PANIER</button>
                    </div>      
                </div>      
            </div>
            <Footer />
